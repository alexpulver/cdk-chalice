...
class Chalice(cdk.Construct):
    ...
    def __init__(self, scope: cdk.Construct, id: str, *, source_dir: str, stage_config: dict,
        ...
        #: (:class:`str`) Path to directory with output of `chalice package` command.
        ...
        self.sam_template = cloudformation_include.CfnInclude(
            self, 'ChaliceApp', template_file=self._get_sam_template_with_assets_path())
    ...
    def _get_sam_template_with_assets_path(self):
        ...
        with open(sam_template_path, 'r+') as sam_template_file:
            ...
            sam_template_file.seek(0)
            sam_template_file.write(json.dumps(sam_template, indent=2))
            sam_template_file.truncate()

        return sam_template_path
